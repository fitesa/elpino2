...
var style_EvolucinIndicedeVegetacin_4 = function(feature, resolution){
    ...
    if (value >= 0.043279 && value <= 0.061985) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.061985 && value <= 0.080690) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.080690 && value <= 0.099395) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.099395 && value <= 0.118100) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.118100 && value <= 0.136806) {
            style = [ new ol.style.Style({
