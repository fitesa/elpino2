...
var style_IndicedeHumedad_3 = function(feature, resolution){
    ...
    if (value >= 0.054030 && value <= 0.131055) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.131055 && value <= 0.208079) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.208079 && value <= 0.285104) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.285104 && value <= 0.362128) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.362128 && value <= 0.439152) {
            style = [ new ol.style.Style({
